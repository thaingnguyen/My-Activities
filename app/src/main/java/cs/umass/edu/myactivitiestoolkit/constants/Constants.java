...
public class Constants {
    ...
    public interface ACTION {
        ...
        String UPDATE_ACTIVITY = "edu.umass.cs.my-activities-toolkit.action.update-activity";
        String COLLECT_DATA = "edu.umass.cs.my-activities-toolkit.action.collect-data";
    }
