...
This is the starter code for extracting features of windows of audio data.
...
class FeatureExtractor():
    ...
    def _compute_pitch_features(self, window):
        ...
        This will give you a feature vector of length len(bins). Remember pitch
        values are in the range [0,128].
